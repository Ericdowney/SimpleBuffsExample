...
This repository contains the example project and full documentation for the [**SimpleBuffs** plugin]().

## What it is

**SimpleBuffs** is a lightweight, modular buffs system tailored for Unreal Engine 5+ projects. Designed with indie developers in mind, it provides a data-driven approach to managing buffs, debuffs, stacking, and refreshing logic without overwhelming complexity.
...
* After purchasing **SimpleBuffs** on Fab, open the example project and follow along with the documentation.
...
* Open a ticket in the [Issues tab](https://github.com/Ericdowney/SimpleBuffsExample/issues)
